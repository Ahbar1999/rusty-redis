pub mod utils {
    ...
    pub const _EARTH_RADIUS_: f64 = 6372797.560856;
    ...
    // maths formula to calculate distance between to coordinates  
    pub fn haversine_dist(origin: &Coordinates, destination: &Coordinates) -> f64 {
